...
<body style="background-color: powderblue;">
	...
	<form id="regForm" method="post" action="cdc-approve.htm">
			...
			<div align="center">
				<table>
					...
					<c:forEach items="${sessionScope.data}" var="request">
						<tr>
							<td>${request.workRequestId}</td>
							<td>${request.vaccine.vaccineName}</td>
							<td>${request.quantity}</td>
							<td>${request.senderOrganization.organizationName}</td>
							<td>${request.receiverEnterprise.enterpriseName}</td>
